    ...
    <main>
        <div class="container">
            <div class="title-block">
                <a href="#" onclick="history.back()" class="history-back-link">Вернуться к объектам</a>
            </div>
            <div class="content-block">
                <div class="main-block">
                    ...
                    <div class="description">
                        <h2>ЖК «Высоцкий»</h2>
                        <span class="info">
                        Проект элитного многоквартирного<br> жилого дома<br> в районе ул. Володарского, 38<br> в г. Владивостоке.
                    </span>
                    </div>
                </div>
                <div class="slider">
                ...
                <div class="third-block">
                    ...
                    <div class="text">
                        <h3>Локация для жизни в гармонии с городом</h3>
